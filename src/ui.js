...
export function createUI(root, actions) {
  ...
  root.innerHTML = `
    ...
    <section id="hub-screen" class="screen hub-screen">
      ...
      <aside class="deployment-panel"><div class="panel-heading"><span class="micro">EINSATZVORBEREITUNG</span><span class="tiny dim">01 / 03</span></div>
        ...
        <div class="selector-label"><span class="micro">DEIN EINSATZLOADOUT</span><span class="tiny dim">IM ARSENAL VORBEREITEN</span></div>
        <div class="kit-choices"><button id="deployment-mode-preset" class="kit-choice" data-action="arsenal-kits"><span class="choice-top"><strong>FERTIGES KIT</strong><span>↗</span></span><span id="deployment-preset-name" class="choice-description">Notfall · Scout</span><span class="choice-line"><span class="selection-dot"></span> FESTER AUFBAU</span></button><button id="deployment-mode-custom" class="kit-choice" data-action="arsenal-loadout"><span class="choice-top"><strong>EIGENES LOADOUT</strong><span>↗</span></span><span class="choice-description">Waffen und Schutz aus deinem Lager.</span><span class="choice-line"><span class="selection-dot"></span> FREI ANPASSBAR</span></button></div>
        ...
        <div class="deployment-cost"><span>BEZAHLUNG BEIM RAIDSTART</span><strong id="deployment-total-cost">0 CR</strong></div>
  ...
  function drawMap() {
    ...
    // Keep door markers above district labels, readable even on the full 300 m map.
    for (const interior of layout.interiors || []) {
