...
import { controllerStatusMarkup } from './controller-ui.js';
...
export function createSettingsUI(container, actions) {
  ...
  update(values);
  return {
    update, handleKey, isCapturingBinding: () => !!capture, cancelCapture: () => stopCapture(),
